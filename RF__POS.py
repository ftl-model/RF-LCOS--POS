...
# Load the model
model = joblib.load('RF__POS.pkl')
scaler = joblib.load('Scaler_.pkl') 

# Define feature names
feature_names = [ "age", " preop_ucg_EF ", "BNP ", " DBIL ", "T3", "UREA", "optime ", " MAP_65_time", "Lac_1st_postop"]
...
MAP_65_time = st.number_input("MAP_65_time（min）:", min_value=0, max_value=1000, value=120)
